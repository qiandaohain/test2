...
<head>
    ...
    <script type="text/javascript">
        ...
        function optDelete(name, isDisplay, pageNo) {
            ...
            // 删除
            $("#jvForm").attr("action", "/brand/deletes.do?name=" + name + "&isDisplay=" + isDisplay + "&pageNo=" + pageNo);//跳转路径
            $("#jvForm").attr("method", "post").submit();//提交
        }
    ...
    <table cellspacing="1" cellpadding="0" border="0" width="100%" class="pn-ltable">
        ...
        <c:forEach items="${pagination.list}" var="brand">
            <tr bgcolor="#ffffff" onmouseout="this.bgColor='#ffffff'" onmouseover="this.bgColor='#eeeeee'">
                ...
                <td align="center">
                    <a class="pn-opt" href="/brand/toEdit.do?id=${brand.id}">修改</a> | <a class="pn-opt" onclick="if(!confirm('您确定删除吗？')) {return false;}"
                                                           href="#">删除</a>
                </td>
            </tr>
        </c:forEach>
